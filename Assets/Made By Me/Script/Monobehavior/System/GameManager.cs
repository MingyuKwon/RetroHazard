...
public class GameManager : MonoBehaviour
{
    ...
    {
        public static event Action<string, string, int, int> showNotice;
        public static void InvokeShowNotice(string showingUI ,string text = null, int panelWidth = 400, int panelHeight = 100)
        {
            // 아무 인수 없이 호출시에, notice를 닫는 것
            showNotice?.Invoke(showingUI, text, panelWidth, panelHeight);
        }
